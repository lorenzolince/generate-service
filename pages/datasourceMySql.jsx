...
import DataSourcesMySql from '../components/DataSourcesMySql';
import dataSources from '../services/datasource';
import swal from 'sweetalert2/dist/sweetalert2.min.js';


const datasourceMySql = () => {
    ...
    const getDataSources = async () => {
        try {
            const response = await dataSources.getAll('MY_SQL');
    ...
    const reloadData = async () => {
        ...
        dataSource.data.forEach(function (item) {
            item.Update = <DataSourcesMySql item={item} reloadData={reloadData}></DataSourcesMySql>
            ...
            <Container>
                <Form>
                    ...
                    <Row>
                        <Col ></Col>
                        <Col md="auto">
                            <DataSourcesMySql reloadData={reloadData}></DataSourcesMySql>
                        </Col>
                    </Row>
                    <Row>
