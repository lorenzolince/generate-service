...
const Sftp = () => {
    ...
    const resulsetSp = async (e, index, data) => {
        swal.fire({
            title: t('sftp:titleAlertResulset'),
            text: t('sftp:textAlertResulset'),
            icon: "success",
            input: "text",
            buttons: true,
                ...
                <Form>
                    ...
                    <Row>
                        <Col md={{ span: 2, offset: 0 }}>
                            <Form.Group>
                                <Form.Label htmlFor="name" >{t('sftp:name')}</Form.Label>
                        ...
                        <Col md={{ span: 2, offset: 0 }}>
                            <Form.Group>
                                <Form.Label htmlFor="domain" >{t('sftp:domain')}</Form.Label>
                        ...
                        <Col md={{ span: 2, offset: 0 }}>
                            {
                                appicationServer ?
                                    <Form.Group>
                                        <Form.Label htmlFor={'applicationService'} >{t('sftp:applicationService')}</Form.Label>
                    ...
                    <Row>
                        <Col md={{ span: 2, offset: 0 }}>
                            {
                                dataBaseType ?
                                    <Form.Group>
                                        <Form.Label htmlFor={'typeDataBase'} >{t('sftp:typeDataBase')}</Form.Label>
                        ...
                        <Col md={{ span: 2, offset: 0 }}>
                            {
                                datasourceDropDown ?
                                    <Form.Group>
                                        <Form.Label htmlFor={'dataSources'} >{t('sftp:dataSources')}</Form.Label>
                        ...
                        {(appServer != "EMBEDDED" && appServer != "TOMCAT" && dataBaseType != null) &&
                            <Col md={{ span: 2, offset: 1 }}>
                                ...
                                <Form.Group>
                                    <Form.Label htmlFor="jndi" >{t('sftp:jndi')}</Form.Label>
                        ...
                        <Col md={{ span: 2, offset: 1 }}>
                            {
                                schemas ?
                                    <Form.Group>
                                        <Form.Label htmlFor={'schema'} >{t('sftp:schema')}</Form.Label>
                        ...
                        {dataProcedures &&
                            <Col md={{ span: 2, offset: 1 }}>
                                <Form.Group>
                                    <Form.Label htmlFor={'procedures'} >{t('sftp:procedures')}</Form.Label>
