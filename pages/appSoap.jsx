...
const AppSoap = () => {
    ...
    const resulsetSp = async (e, index, data) => {
        swal.fire({
            title: t('appSoap:titleAlertResulset'),
            text: t('appSoap:textAlertResulset'),
            icon: "success",
            input: "text",
            buttons: true,
    ...
    const onSubmitShema = async (data) => {
        await onSubmit(data, "XSD")

    }

    const onSubmitBinary = async (data) => {
        await onSubmit(data, "BINARY")
    }
    ...
    return (
        <>
            <title>{t('appSoap:title')}</title>
            <Container>
                <Form>
                    <Row>
                        <Col>
                            <h3>{t('appSoap:title')}</h3>
                        </Col>
                    </Row>
                    <Row>
                        <Col md={{ span: 2, offset: 0 }}>
                            <Form.Group>
                                <Form.Label htmlFor="name" >{t('appSoap:name')}</Form.Label>
                        ...
                        <Col md={{ span: 2, offset: 0 }}>
                            <Form.Group>
                                <Form.Label htmlFor="domain" >{t('appSoap:domain')}</Form.Label>
                        ...
                        <Col md={{ span: 2, offset: 0 }}>
                            {
                                appicationServer ?
                                    <Form.Group>
                                        <Form.Label htmlFor={'applicationService'} >{t('appSoap:applicationService')}</Form.Label>
                        ...
                        <Col md={{ span: 2, offset: 1 }}>
                            {
                                dataBaseType ?
                                    <Form.Group>
                                        <Form.Label htmlFor={'typeDataBase'} >{t('appSoap:typeDataBase')}</Form.Label>
                    ...
                    <Row>
                        <Col md={{ span: 2, offset: 0 }}>
                            {
                                datasourceDropDown ?
                                    <Form.Group>
                                        <Form.Label htmlFor={'dataSources'} >{t('appSoap:dataSources')}</Form.Label>
                        ...
                        {(appServer != "EMBEDDED" && appServer != "TOMCAT" && dataBaseType != null) &&
                            <Col md={{ span: 2, offset: 1 }}>
                                ...
                                <Form.Group>
                                    <Form.Label htmlFor="jndi" >{t('appSoap:jndi')}</Form.Label>
                        ...
                        <Col md={{ span: 2, offset: 1 }}>
                            {
                                schemas ?
                                    <Form.Group>
                                        <Form.Label htmlFor={'schema'} >{t('appSoap:schema')}</Form.Label>
                        ...
                        {dataProcedures &&
                            <Col md={{ span: 2, offset: 1 }}>
                                ...
                                <Form.Group>
                                    <Form.Label htmlFor={'procedures'} >{t('appSoap:procedures')}</Form.Label>
                                ...
                                <Col >
                                    <Button className="common-button-color" type="button" disabled={formState.isSubmitting} onClick={
                                        async () => {
                                            ...
                                            swal.fire({
                                                title: t('appSoap:titleAlertDevops'),
                                                ...
                                                if (result.isConfirmed && value !== "") {
                                                    handleSubmit(async (formData) => {
                                                        ...
                                                        await onSubmit(formData, "DEVOPS");
                                                    })();
                                                }
                                            });
                                        }
