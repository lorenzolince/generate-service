...
const AppWebSocket = () => {
    ...
    const resulsetSp = async (e, index, data) => {
        swal.fire({
            title: t('appWebSocket:titleAlertResulset'),
            text: t('appWebSocket:textAlertResulset'),
            icon: "success",
            input: "text",
            buttons: true,
    ...
    const onSubmit = async (data) => {
        await generateDataApp(data, "WEBSOCKET")
    }
    ...
    const generateDataApp = async (data, schema) => {
        ...
        if (schema === "JSON_XSD") {
            ...
            datagenerate.typeSevice = "WEBSOCKET";
    ...
    return (
        <>
            <title>{t('appWebSocket:title')}</title>
            <Container>
                <Form>
                    <Row>
                        <Col>
                            <h3>{t('appWebSocket:title')}</h3>
                        </Col>
                    </Row>
                    <Row>
                        <Col md={{ span: 2, offset: 0 }}>
                            <Form.Group>
                                <Form.Label htmlFor="name" >{t('appWebSocket:name')}</Form.Label>
                        ...
                        <Col md={{ span: 2, offset: 0 }}>
                            <Form.Group>
                                <Form.Label htmlFor="domain" >{t('appWebSocket:domain')}</Form.Label>
                        ...
                        <Col md={{ span: 2, offset: 0 }}>
                            {
                                appicationServer ?
                                    <Form.Group>
                                        <Form.Label htmlFor={'applicationService'} >{t('appWebSocket:applicationService')}</Form.Label>
                        ...
                        <Col md={{ span: 2, offset: 1 }}>
                            {
                                dataBaseType ?
                                    <Form.Group>
                                        <Form.Label htmlFor={'typeDataBase'} >{t('appWebSocket:typeDataBase')}</Form.Label>
                    ...
                    <Row>
                        <Col md={{ span: 2, offset: 0 }}>
                            {
                                datasourceDropDown ?
                                    <Form.Group>
                                        <Form.Label htmlFor={'dataSources'} >{t('appWebSocket:dataSources')}</Form.Label>
                        ...
                        {(appServer != "EMBEDDED" && appServer != "TOMCAT" && dataBaseType != null) &&
                            <Col md={{ span: 2, offset: 1 }}>
                                ...
                                <Form.Group>
                                    <Form.Label htmlFor="jndi" >{t('appWebSocket:jndi')}</Form.Label>
                        ...
                        <Col md={{ span: 2, offset: 1 }}>
                            {
                                schemas ?
                                    <Form.Group>
                                        <Form.Label htmlFor={'schema'} >{t('appWebSocket:schema')}</Form.Label>
                        ...
                        {dataProcedures &&
                            <Col md={{ span: 2, offset: 1 }}>
                                <Form.Group>
                                    <Form.Label htmlFor={'procedures'} >{t('appWebSocket:procedures')}</Form.Label>
                                ...
                                <Col >
                                    <Button className="common-button-color" type="button" disabled={formState.isSubmitting} onClick={
                                        async () => {
                                            ...
                                            swal.fire({
                                                title: t('appWebSocket:titleAlertDevops'),
