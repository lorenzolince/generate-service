...
import DataSourcesPostgres from '../components/DataSourcesPostgres';
...
const datasourcePostgres = () => {
    ...
    const getDataSources = async () => {
        try {
            const response = await dataSources.getAll('POSTGRES');
    ...
    const reloadData = async () => {
        ...
        dataSource.data.forEach(function (item) {
            item.Update = <DataSourcesPostgres item={item} reloadData={reloadData}></DataSourcesPostgres>
            ...
            <Container>
                <Form>
                    ...
                    <Row>
                        <Col ></Col>
                        <Col md="auto">
                            <DataSourcesPostgres reloadData={reloadData}></DataSourcesPostgres>
                        </Col>
                    </Row>
                    <Row>
