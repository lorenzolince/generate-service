...
const Grpc = () => {
    ...
    const resulsetSp = async (e, index, data) => {
        swal.fire({
            title: t('grpc:titleAlertResulset'),
            text: t('grpc:textAlertResulset'),
            icon: "success",
            input: "text",
            buttons: true,
    ...
    const onSubmit = async (data) => {
        await generateDataApp(data, "GRPC")
    }
    ...
    const onSubmitShema = async (data) => {
        await generateDataApp(data, "GRPC_XSD")
                ...
                <Form>
                    ...
                    <Row>
                        <Col md={{ span: 2, offset: 0 }}>
                            <Form.Group>
                                <Form.Label htmlFor="name" >{t('grpc:name')}</Form.Label>
                        ...
                        <Col md={{ span: 2, offset: 1 }}>
                            <Form.Group>
                                <Form.Label htmlFor="domain" >{t('grpc:domain')}</Form.Label>
                        ...
                        <Col md={{ span: 2, offset: 1 }}>
                            {
                                dataBaseType ?
                                    <Form.Group>
                                        <Form.Label htmlFor={'typeDataBase'} >{t('grpc:typeDataBase')}</Form.Label>
                    ...
                    <Row>
                        <Col md={{ span: 2, offset: 0 }}>
                            {
                                datasourceDropDown ?
                                    <Form.Group>
                                        <Form.Label htmlFor={'dataSources'} >{t('grpc:dataSources')}</Form.Label>
                        ...
                        <Col md={{ span: 2, offset: 1 }}>
                            {
                                schemas ?
                                    <Form.Group>
                                        <Form.Label htmlFor={'schema'} >{t('grpc:schema')}</Form.Label>
                        ...
                        {dataProcedures &&
                            <Col md={{ span: 2, offset: 1 }}>
                                <Form.Group>
                                    <Form.Label htmlFor={'procedures'} >{t('grpc:procedures')}</Form.Label>
